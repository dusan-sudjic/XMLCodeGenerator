...
{
    public sealed class StringIsNullOrEmptyElement: BooleanOperator
    {
        public override int MinContentSize { get { return 1; } }
        public override int MaxContentSize { get { return 1; } }
        public override string XML_Name { get { return "StringIsNullOrEmpty"; } }
        public StringIsNullOrEmptyElement() : base() { }
    }
}
