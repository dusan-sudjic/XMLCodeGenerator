...
{
    public sealed class StringLastIndexOfElement : Expression
    {
        public override int MinContentSize { get { return 2; } }
        public override int MaxContentSize { get { return 2; } }
        public override string XML_Name { get { return "StringLastIndexOf"; } }
        public StringLastIndexOfElement() : base() { }
    }
}
